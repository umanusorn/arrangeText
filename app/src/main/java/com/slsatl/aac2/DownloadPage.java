...
public class DownloadPage extends Activity{
	...
	String categoryRequest_url= "http://www.sls-atl.com/?q=aac2/webservice&action=categories";
	String baseKeywordUrlRequest = "http://www.sls-atl.com/?q=aac2/webservice&action=categories&keyword=";
	String downloadBasePath_url = "http://www.sls-atl.com/?q=aac2%2Fwebservice&action=download&cid=";
   	...
   	if(canConnect){
		printTable();
   		...
   		try {
			...
			String base_path = d1.getString("aac2-pict-url");
       ...
       /////
        ...
        download.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
            	...
            	File file1 = new File(Environment.getExternalStorageDirectory() + "/AAConAndroid/aac2.png");
    ...
    public void printTable(){
    	...
    	try{
    		...
    		//modify your query here
	   	  	Cursor cursor = db.query(Constant.TABLE_NEW_CATE, new String[] { "enable","core","nextCid","variation","subtitle","cid","version","weight","title","coverPath","lang" }, null,null, null, null, null, null);
	...
	public class fetchIconResult extends AsyncTask<String, Void, Void> {
			...
			try {
				...
				long total = 0;
	    			...
	    			for(int i =0;i<data_row.length();i++){
	    				...
	    				String category = data_row.getJSONObject(i).getString(Constant.TABLE_NEW_CATE);
	    				...
	    				String sql ="insert or replace into "+Constant.TABLE_NEW_CATE+" (enable,core,nextCid,variation,subtitle,cid,version,weight,title,coverPath,lang) values("+enable+","+core+","+nextCid+","+variation+","+"'"+subtitle+"',"+cid+","+version+","+weight+",'"+title+"','"+coverPath+"','"+lang+"')";
        				Log.d("databaseExe",sql);
	    				db.execSQL(sql);
        				sql = "delete from lexicalItem where cid="+cid;
        				Log.d("database",sql);
        				db.execSQL(sql);
	 ...
	 public class DownloadAdapter extends ArrayAdapter<BitmapAndLabel> {
	        ...
	        public void createRowForCategory(Vector <ConstantDBfromDownload>a, int pos) {
	    		...
	    		initialValues.put(Constant.TABLE_NEW_CATE, a.elementAt(pos).cate);
	    		...
	    		// voice must retrieve from smwhr
	    		initialValues.put("voice",a.elementAt(pos).sound );
	    		vocabValues.put(Constant.TABLE_NEW_CATE, a.elementAt(pos).cate);
		    ...
		    protected Void doInBackground(final String... args) {
	            ...
	            if(canConnect){
	              ...
	              try {
		      			...
		      			JSONObject d1 = data_raw.getJSONObject(0);
		      			String base_path = d1.getString("aac2-pict-url");
		      			String category = d1.getString(Constant.TABLE_NEW_CATE);
